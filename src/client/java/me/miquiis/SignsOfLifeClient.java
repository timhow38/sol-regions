...
import me.thepond.screens.SignsOfLifeOptionsScreen;
...
public class SignsOfLifeClient implements ClientModInitializer, ModMenuApi {
	...
	public ConfigScreenFactory<?> getModConfigScreenFactory() {
		return SignsOfLifeOptionsScreen::new;
	}
	...
	public void onInitializeClient() {
		...
		ResourceManagerHelper.get(ResourceType.CLIENT_RESOURCES).registerReloadListener(new SimpleSynchronousResourceReloadListener() {
			private static final Identifier ID = new Identifier(SignsOfLife.MOD_ID, "texture_reload_listener");
			@Override
					...
					if (itemStack.hasNbt()) {
						...
						if (nbt.contains("region")) {
							...
							if (player.isSneaking()) {
								SignsOfLife.LOGGER.info("Removing vertex at: " + pos + " for region: " + regionName);
								...
								SignsOfLife.LOGGER.info("Adding vertex at: " + pos + " for region: " + regionName);
